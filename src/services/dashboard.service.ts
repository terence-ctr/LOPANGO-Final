...
class DashboardService {
  // Récupérer les statistiques du tableau de bord (méthode simplifiée)
  static async getDashboardStats(): Promise<DashboardStats> {
    try {
      ...
      const [
        ...
        this.getDetailedDashboardStats(),
        this.getRecentPayments({ limit: 5 }),
        this.getRecentAlerts({ limit: 5, actionRequired: true }),
        this.getUpcomingEvents({ limit: 5 })
      ]);

      // Compter les propriétés actives (louées)
      ...
      return {
        ...
        totalContracts: stats.activeContracts || 0,
        recentPayments,
        recentAlerts,
        upcomingEvents
      };
      ...
      // Retourner un objet vide avec les champs requis
      return {
        totalProperties: 0,
        activeProperties: 0,
        totalTenants: 0,
  ...
  // Récupérer les statistiques détaillées du tableau de bord
  static async getDetailedDashboardStats(): Promise<{
    totalProperties: number;
